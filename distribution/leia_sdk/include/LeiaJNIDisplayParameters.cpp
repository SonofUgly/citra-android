...
std::string
    LeiaJNIDisplayParameters::mMethodNames[NUMBER_OF_SYSTEM_PARAMETERS] = {
        "GetViewSharpening",   "GetAlignmentOffset",   "GetSystemDisparity",
        "GetScreenResolution", "GetNumAvailableViews", "GetViewResolution"};

std::string
    LeiaJNIDisplayParameters::mMethodSignatures[NUMBER_OF_SYSTEM_PARAMETERS] = {
        "()[F", "()F", "()I", "()[I", "()[I", "()[I"};
...
bool LeiaJNIDisplayParameters::ReadSystemViewSharpeningParameters(
  ...
  jfloatArray params =
      (jfloatArray)jni->CallObjectMethod(activity->clazz, methodID);
...
bool LeiaJNIDisplayParameters::ReadSystemAlignmentOffset(
    ANativeActivity *activity) {
...
bool LeiaJNIDisplayParameters::ReadSystemScreenResolution(
    ANativeActivity *activity) {
  ...
  jintArray params =
      (jintArray)jni->CallObjectMethod(activity->clazz, methodID);
...
bool LeiaJNIDisplayParameters::ReadSystemNumAvailableViews(
    ANativeActivity *activity) {
...
bool LeiaJNIDisplayParameters::ReadSystemViewResolution(
    ANativeActivity *activity) {
  bool view_dims_received = false;
...
jmethodID
LeiaJNIDisplayParameters::GetMethod(ANativeActivity *activity, JNIEnv *jni,

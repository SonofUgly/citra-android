...
void leiaInitializeCameraData(LeiaCameraData* data, int num_horizontal_views,
                              int num_vertical_views, float system_disparity_in_pixels,
                              float baseline_scaling, float convergence_distance,
                              float vertical_field_of_view_degrees, float near, float far,
                              int view_resolution_x_pixels, int view_resolution_y_pixels);
int leiaCalculateViews(LeiaCameraData* data, LeiaCameraView* out_views, int len_views_in_x,
                       int len_views_in_y);

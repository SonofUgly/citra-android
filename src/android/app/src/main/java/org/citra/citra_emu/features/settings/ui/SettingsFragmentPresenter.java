...
public final class SettingsFragmentPresenter {
    ...
    private void addGraphicsSettings(ArrayList<SettingsItem> sl) {
        ...
        sl.add(new SliderSetting(SettingsFile.KEY_RESOLUTION_FACTOR, Settings.SECTION_RENDERER, R.string.internal_resolution, R.string.internal_resolution_description, 1, 8, "x", 1, resolutionFactor));
